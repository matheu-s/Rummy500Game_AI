...
class Board:
    ...
    def start_board(self, screen):
        ...
        self.hidden_deck_rect = screen.blit(hidden_deck, (400, (HEIGHT/2) - (hidden_deck_heigth/2)))
        ...
        for i in self.human_cards:
            ...
            screen.blit(card, (400+counter, (HEIGHT) - (card_height + 20)))
            counter += 25
        ...
        for i in self.engine_cards:
            ...
            screen.blit(card, (400+counter, 20))
            counter += 25

        for i in self.pile:
            card = pygame.transform.scale(i.image, (int(card_width), int(card_height)))
            counter += 25
            screen.blit(card, (550, (HEIGHT / 2) - (hidden_deck_heigth / 2)))
